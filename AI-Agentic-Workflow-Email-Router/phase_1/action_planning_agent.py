# : 1 - Import all required libraries, including the ActionPlanningAgent
import os
from dotenv import load_dotenv
from workflow_agents.base_agents import ActionPlanningAgent

# : 2 - Load environment variables and define the openai_api_key variable with your OpenAI API key
load_dotenv()
...
# : 3 - Instantiate the ActionPlanningAgent, passing the openai_api_key and the knowledge variable
action_planning_agent = ActionPlanningAgent(openai_api_key, knowledge)
# : 4 - Print the agent's response to the following prompt: "One morning I wanted to have scrambled eggs"

prompt = f"""One morning I wanted to have scrambled eggs"""

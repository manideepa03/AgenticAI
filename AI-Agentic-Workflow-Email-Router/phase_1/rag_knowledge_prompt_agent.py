# : 1 - Import RAGKnowledgePromptAgent
import os
...
RAG_knowledge_prompt_agent = # : 2 - Instantiate RAGKnowledgePromptAgent
...
chunks = # : 3 - Compute the knowledge_text the chunks
embbedings = # : 4 - Compute the knowledge_text the chunk embbedings
